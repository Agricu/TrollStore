...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	if([registrationState isEqualToString:NSLocalizedString(@"System",nil)])
	{
		switchState = NSLocalizedString(@"User",nil);
		switchActionStyle = UIAlertActionStyleDestructive;
	}
	else if([registrationState isEqualToString:NSLocalizedString(@"User",nil)])
	{
		switchState = NSLocalizedString(@"System",nil);
